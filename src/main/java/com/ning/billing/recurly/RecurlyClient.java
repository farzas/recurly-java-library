...
public class RecurlyClient {
     ...
     * Get Subscriptions given query params
     * <p>
     * Returns information about all the subscriptions on the site.
     *
     * @param params {@link QueryParams}
     * @return Subscriptions on success, null otherwise
     */

    public Subscriptions getSubscriptions(final QueryParams params) {
